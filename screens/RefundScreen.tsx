...
const RefundScreen: React.FC<Props> = ({ onNavigate }) => {
  return (
    <div className="flex flex-col h-full bg-background-dark text-white overflow-hidden relative">
      <header className="px-6 pt-12 pb-4">
        ...
        <p className="text-slate-400 text-sm mt-4">Information about course refunds.</p>
      </header>
      ...
      <main className="flex-1 px-6 pt-8">
        <div className="bg-zinc-900/50 border border-white/5 rounded-[32px] p-8">
          ...
          <div className="space-y-2">
            <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Status</h3>
            <p className="text-2xl font-medium text-primary">
              Not Applicable
            </p>
            <p className="text-sm text-slate-400 mt-4">
              All purchases made on this platform are final and non-refundable.
            </p>
          </div>
        </div>
      </main>
